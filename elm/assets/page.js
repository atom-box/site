...
var author$project$Page$init = A3(
...
var author$project$Page$Add = {$: 'Add'};
var author$project$Page$Filter = function (a) {
	return {$: 'Filter', a: a};
};
var author$project$Page$blankLine = '';
var author$project$Page$direction1 = 'Try typing \'we\' into the box.';
var author$project$Page$direction2 = 'Search results:';
...
var author$project$Page$viewEntry = function (entry) {
	return A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(author$project$Page$direction1)
					])),
				A2(
				elm$html$Html$input,
				_List_fromArray(
					[
						elm$html$Html$Attributes$placeholder('enter a search term'),
						elm$html$Html$Events$onInput(author$project$Page$Filter)
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Page$Add)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Add New Amendment!')
					])),
				A2(
				elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(author$project$Page$blankLine)
					])),
				A2(
				elm$html$Html$p,
				_List_fromArray(
				...
				_List_fromArray(
					[
						elm$html$Html$text(author$project$Page$direction2)
					])),
				A2(
				elm$html$Html$ul,
				_List_Nil,
				A2(elm$core$List$map, author$project$Page$viewEntry, model.results))
			]));
};
